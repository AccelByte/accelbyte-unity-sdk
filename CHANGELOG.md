...
* add AMS DS self claim message api 
* added get input validation with namespace 
* introduce getapi function to get custom api generated by extend codegen 


### Bug Fixes

* add default constructor to Error class for JSON deserialization 
