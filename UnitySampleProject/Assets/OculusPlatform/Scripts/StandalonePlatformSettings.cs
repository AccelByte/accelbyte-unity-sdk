namespace Oculus.Platform
{
  ...
  public sealed class StandalonePlatformSettings
  {
    ...
    public static string OculusPlatformTestUserPassword
    {
      ...
      {
#if UNITY_EDITOR
        StandalonePlatformSettings.ClearOldStoredPassword();
        return StandalonePlatformSettings._OculusPlatformTestUserPassword;
#else
        return string.Empty;
#endif
      }
...
#if UNITY_EDITOR
        StandalonePlatformSettings.ClearOldStoredPassword();
        StandalonePlatformSettings._OculusPlatformTestUserPassword = value;
#endif
      }
    }
