...
namespace Oculus.Platform.Models
{
  ...
  public class MatchmakingAdminSnapshotCandidateList : DeserializableList<MatchmakingAdminSnapshotCandidate> {
    public MatchmakingAdminSnapshotCandidateList(IntPtr a) {
      ...
      this._Data = new List<MatchmakingAdminSnapshotCandidate>(count);
      for (int i = 0; i < count; i++) {
        this._Data.Add(new MatchmakingAdminSnapshotCandidate(CAPI.ovr_MatchmakingAdminSnapshotCandidateArray_GetElement(a, (UIntPtr)i)));
      }
