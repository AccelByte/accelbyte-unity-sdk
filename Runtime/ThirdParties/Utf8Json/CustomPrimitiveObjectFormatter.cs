...
{
    public sealed class CustomPrimitiveObjectFormatter : IJsonFormatter<object>
    {
        public static readonly IJsonFormatter<object> Default = new CustomPrimitiveObjectFormatter();
