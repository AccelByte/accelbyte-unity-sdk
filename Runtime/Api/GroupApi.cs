...
namespace AccelByte.Api
{
    public class GroupApi : ApiBase
    {
            ...
            , ResultCallback<GroupInformation> callback )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't get group information! AccessToken parameter is null!");
            ...
            , ResultCallback<GroupInformation> callback )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't update group information! AccessToken parameter is null!");
            ...
            , ResultCallback<GroupInformation> callback )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't update group custon rule! AccessToken parameter is null!");
            ...
            , ResultCallback<GroupInformation> callback )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't update group predefined rule! AccessToken parameter is null!");
            ...
            , ResultCallback callback )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't delete group predefined rule! AccessToken parameter is null!");
            ...
            var request = HttpRequestBuilder
                .CreateDelete(BaseUrl + "/v1/public/namespaces/{namespace}/groups/{groupId}/rules/defined/{allowedAction}")
                .WithPathParam("namespace", Namespace_)
                .WithPathParam("groupId", groupId)
                .WithPathParam("allowedAction", allowedAction.ToString())
                .WithBearerAuth(AuthToken)
            ...
            , ResultCallback<GroupMemberInformation> callback )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't get user's group information! AccessToken parameter is null!");
            ...
            , ResultCallback<GroupGeneralResponse> callback )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't accept group invitation! AccessToken parameter is null!");
            ...
            , ResultCallback<GroupGeneralResponse> callback )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't reject group invitation! AccessToken parameter is null!");
            ...
            , ResultCallback<UserInvitationResponse> callback )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't invite other user to group! AccessToken parameter is null!");
            ...
            , ResultCallback<GroupGeneralResponse> callback )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't cancel join group request! AccessToken parameter is null!");
            ...
            , int offset = 0 )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't get group member list ! AccessToken parameter is null!");
            ...
            , ResultCallback<KickMemberResponse> callback )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't kick a group member! AccessToken parameter is null!");
            ...
            , int offset = 0 )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't get group join requests! AccessToken parameter is null!");
            ...
            , ResultCallback<GroupGeneralResponse> callback )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't accept other user join request! AccessToken parameter is null!");
            ...
            , ResultCallback<GroupGeneralResponse> callback )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't reject other user join request! AccessToken parameter is null!");
            ...
            , ResultCallback<GroupMemberInformation> callback )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't assign group role request! AccessToken parameter is null!");
            ...
            , ResultCallback callback )
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't remove group role request! AccessToken parameter is null!");
        ...
        {
            Report.GetFunctionLog(GetType().Name);
            Assert.IsFalse(string.IsNullOrEmpty(AuthToken), "Can't get group role request! AccessToken parameter is null!");
